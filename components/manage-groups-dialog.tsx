...
export function ManageGroupsDialog({ groups, onAddGroup, onUpdateGroup, onRemoveGroup }: ManageGroupsDialogProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[500px] max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Organisez vos joueurs en groupes pour une meilleure gestion.</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          {showAddForm && (
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">{editingGroup ? "Modifier le groupe" : "Nouveau groupe"}</CardTitle>
              </CardHeader>
              <CardContent>
